...
int main() {
    ...
    float time = 0;
    int triangley[3] = {static_cast<int>(HEIGHT*0.75), static_cast<int>(HEIGHT*0.75), static_cast<int>(HEIGHT*0.25)};
    int trianglex[3] = {static_cast<int>(WIDTH*0.75), static_cast<int>(WIDTH*0.25), static_cast<int>(WIDTH*0.5)};
